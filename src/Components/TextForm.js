    ...
    return (
        <>
            <div className="container my-3 " style={{ color: props.mode === "dark" ? "white" : "black" }}>
                ...
                <button className="btn btn-primary my-1 mx-2" onClick={handleLoClick}>
                    Convert to Lowercase
                </button>
                <button className="btn btn-primary my-2 mx-2" onClick={handleCopy}>
                    Copy Text
                </button>
                <button className="btn btn-danger my-2 mx-2" onClick={handleDeClick}>
                    Delete
                </button>
                <button
            ...
            >
                ...
                <p>
                    {text.length > 0
                        ? text
                        : "Enter something in above textarea to preview  it here"}{" "}
                </p>
            </div>
        </>
    );
